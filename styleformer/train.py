...
from styleformer.models import build_model
from styleformer.utils import (MessageLogger, check_resume, get_env_info, get_root_logger, get_time_str, init_tb_logger,
...
def train_pipeline(root_path):
    ...
    logger = get_root_logger(logger_name='styleformer', log_level=logging.INFO, log_file=log_file)
    ...
    for epoch in range(start_epoch, total_epochs + 1):
        ...
        while train_data is not None:
            ...
            if current_iter > 1000000000:
                    save_checkpoint_freq = save_checkpoint_freq / 2.
            ...
            if opt.get('val') is not None:
                start_val_iter = opt['val'].get('start_iter', 0)
                if current_iter > start_val_iter:
